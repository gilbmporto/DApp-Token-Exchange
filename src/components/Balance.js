...
import GilT from '../assets/GilT.png';
import JbtT from '../assets/JbtT.png';

import { loadBalances, transferTokens } from '../store/interactions.js';
...
const Balance = () => {
    ...
    // [x] Step 3: Get notification from blockchain that transfer was successful
    // [x] Step 4: Notify app that transfer was successful
    // [x] Step 5: Handle transfer fails
    ...
    return (
        ...
        <div className='exchange__transfers--form'>
            <div className='flex-between'>
                <p><small>Token</small><br /><img className='token' src={GilT} alt="Token Logo" />{symbols && symbols[0]}</p>
        ...
        <div className='exchange__transfers--form'>
            <div className='flex-between'>
                <p><small>Token</small><br /><img className='token' src={JbtT} alt="Token Logo" />{symbols && symbols[1]}</p>
